...
public class Database {
    private static final String URL = "jdbc:postgresql://localhost:3200/postgres";
    ...
    public static void createReadingListsTable() {
        try (Connection con = getConnection();
             Statement stmt = con.createStatement()) {
            String createTableQuery = "DROP TABLE IF EXISTS reading_lists CASCADE;"
            ...
            System.err.println("Error creating reading lists table: " + e.getMessage());
            e.printStackTrace();
        }
    }
